// 3D Model Presets
// All presets are editable by the user
...
const MODEL_PRESETS = {
    ...
    hollowCube: {
        ...
        vs: [
            ...
            // Inner hole vertices
            { x: 0.10, y: 0.10, z: 0.25 },  // 8  inner front top right
            { x: -0.10, y: 0.10, z: 0.25 },  // 9  inner front top left
            { x: -0.10, y: -0.10, z: 0.25 },  // 10 inner front bottom left
            { x: 0.10, y: -0.10, z: 0.25 },  // 11 inner front bottom right
            { x: 0.10, y: 0.10, z: -0.25 },  // 12 inner back top right
            { x: -0.10, y: 0.10, z: -0.25 },  // 13 inner back top left
            { x: -0.10, y: -0.10, z: -0.25 },  // 14 inner back bottom left
            { x: 0.10, y: -0.10, z: -0.25 },  // 15 inner back bottom right
        ],
        fs: [
            // Outer walls (no front/back - those have holes)
            [4, 5, 1, 0],
            [3, 2, 6, 7],
            [0, 3, 7, 4],
            [5, 6, 2, 1],
    ...
    penguin: {
        ...
        fs: [
            [22, 2, 10], [21, 1, 24], [7, 23, 14], [2, 25, 8], [0, 21, 24], [1, 23, 18], [3, 23, 11], [2, 19, 10], [19, 7, 12], [6, 19, 12], [22, 0, 9], [20, 5, 15], [13, 15, 4], [7, 20, 12], [5, 23, 17], [25, 1, 18], [22, 4, 16], [6, 22, 10], [19, 3, 11], [24, 9, 0], [4, 21, 16], [5, 21, 15], [25, 3, 8], [6, 20, 13], [34, 35, 46], [35, 36, 46], [33, 51, 42], [36, 37, 46], [34, 37, 28], [76, 58, 64], [28, 50, 34], [77, 53, 62], [47, 33, 40], [76, 52, 70], [32, 47, 40], [75, 52, 61], [28, 47, 38], [42, 43, 48], [41, 43, 30], [40, 42, 48], [31, 51, 45], [73, 54, 64], [50, 30, 44], [32, 50, 38], [76, 56, 67], [75, 53, 71], [60, 61, 52], [73, 55, 63], [61, 62, 53], [75, 57, 69], [62, 63, 55], [77, 55, 65], [60, 63, 72], [76, 54, 60], [59, 73, 66], [77, 59, 68], [73, 58, 66], [29, 47, 37], [68, 69, 57], [77, 57, 71], [67, 69, 74], [68, 66, 74], [27, 49, 45], [75, 56, 70], [67, 66, 58], [26, 50, 44], [49, 26, 44], [29, 51, 39], [30, 49, 44], [31, 49, 43], [51, 27, 45], [40, 41, 32], [90, 224, 211], [93, 224, 132], [212, 141, 224], [224, 85, 211], [102, 225, 151], [217, 145, 225], [225, 84, 216], [151, 216, 91], [90, 226, 132], [83, 226, 130], [129, 131, 226], [226, 93, 132], [88, 227, 197], [172, 200, 227], [200, 146, 227], [227, 97, 197], [183, 159, 108], [109, 228, 183], [166, 182, 228], [228, 107, 159], [103, 229, 152], [218, 143, 229], [143, 217, 229], [152, 217, 102], [204, 207, 126], [105, 230, 204], [209, 193, 230], [230, 127, 207], [141, 134, 85], [87, 231, 141], [231, 113, 199], [231, 105, 134], [195, 188, 119], [120, 232, 195], [175, 198, 232], [232, 95, 188], [187, 222, 116], [112, 233, 187], [214, 205, 233], [233, 127, 222], [115, 234, 194], [186, 161, 234], [234, 101, 185], [194, 185, 114], [121, 235, 156], [179, 203, 235], [235, 125, 206], [156, 206, 126], [102, 236, 162], [151, 128, 236], [236, 82, 148], [162, 148, 100], [96, 237, 142], [138, 128, 237], [237, 91, 140], [142, 140, 99], [163, 202, 122], [121, 238, 163], [201, 177, 238], [238, 123, 202
209, 253, 184], [105, 199, 253], [199, 113, 208], [253, 208, 89], [111, 167, 254], [167, 94, 219], [254, 219, 80], [221, 254, 191], [92, 215, 255], [215, 81, 184], [255, 184, 89], [171, 255, 220], [119, 188, 256], [188, 95, 133], [256, 133, 83], [190, 256, 150], [87, 212, 257], [212, 93, 136], [257, 136, 98], [169, 257, 210], [147, 258, 138], [108, 164, 258], [164, 100, 148], [258, 148, 82], [108, 159, 259], [159, 107, 165], [259, 165, 101], [259, 149, 100], [111, 176, 260], [176, 109, 168], [260, 168, 78], [167, 260, 173], [126, 206, 261], [206, 125, 137], [261, 137, 85], [204, 261, 134], [96, 180, 262], [78, 168, 262], [262, 168, 109], [262, 183, 108], [107, 158, 263], [158, 119, 190], [263, 190, 114], [165, 263, 185], [106, 196, 264], [122, 202, 264], [264, 202, 123], [264, 191, 80], [90, 211, 265], [211, 85, 137], [265, 137, 125], [153, 265, 223], [122, 139, 266], [117, 143, 266], [266, 143, 118], [163, 266, 179], [174, 267, 155], [79, 175, 267], [175, 120, 192], [155, 267, 192], [156, 268, 201], [126, 207, 268], [207, 127, 205], [268, 205, 124], [90, 153, 269], [153, 115, 194], [269, 194, 114], [130, 269, 150], [182, 270, 158], [110, 189, 270], [189, 120, 195], [270, 195, 119], [115, 223, 271], [223, 125, 203], [271, 203, 118], [186, 271, 218], [272, 281, 292], [273, 282, 292], [292, 282, 275], [292, 283, 274], [283, 293, 284], [283, 275, 285], [285, 279, 286], [284, 293, 286], [278, 286, 294], [279, 288, 294], [294, 288, 277], [294, 289, 276], [289, 295, 290], [289, 277, 291], [291, 273, 281], [290, 295, 281], [274, 284, 296], [278, 287, 296], [296, 287, 276], [296, 290, 272], [279, 285, 297], [275, 282, 297], [297, 282, 273], [297, 291, 277], [298, 306, 318], [318, 308, 299], [318, 309, 301], [300, 309, 318], [310, 319, 309], [309, 319, 311], [312, 305, 311], [310, 304, 312], [304, 313, 320], [320, 314, 305], [320, 315, 303], [302, 315, 320], [316, 321, 315], [315, 321, 317], [307, 299, 317], [316, 298, 307], [300, 306, 322], [322, 313, 304], [322, 316, 302], [298, 316, 322], [305, 314, 323], [323, 308, 301], [323, 317, 299], [303, 317, 323]]
    },
    ...
    spikedStar: {
        name: "Spiked Star",
        vs: [
            { x: 0.0,   y: 0.45,  z: 0.0 },    // 0: +Y tip
            { x: 0.0,   y: -0.45, z: 0.0 },    // 1: -Y tip
            { x: 0.45,  y: 0.0,   z: 0.0 },    // 2: +X tip
            { x: -0.45, y: 0.0,   z: 0.0 },    // 3: -X tip
            { x: 0.0,   y: 0.0,   z: 0.45 },   // 4: +Z tip
            { x: 0.0,   y: 0.0,   z: -0.45 },  // 5: -Z tip
            { x: 0.08,  y: 0.08,  z: 0.08 },   // 6
            { x: -0.08, y: 0.08,  z: 0.08 },   // 7
            { x: -0.08, y: 0.08,  z: -0.08 },  // 8
            { x: 0.08,  y: 0.08,  z: -0.08 },  // 9
            { x: 0.08,  y: -0.08, z: 0.08 },   // 10
            { x: -0.08, y: -0.08, z: 0.08 },   // 11
            { x: -0.08, y: -0.08, z: -0.08 },  // 12
            { x: 0.08,  y: -0.08, z: -0.08 },  // 13
        ],
        fs: [
            [0, 6, 9], [0, 9, 8], [0, 8, 7], [0, 7, 6],
